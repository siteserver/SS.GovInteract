<%@ Page Language="C#" Inherits="SS.GovInteract.Pages.PageContentReply" %>
  <!DOCTYPE html>
  <html>
  ...
  <body>
    <form class="m-l-15 m-r-15 m-t-15" runat="server">
      ...
      <ul class="nav nav-tabs tabs-bordered mb-20">
        <li class="nav-item">
          <a class="nav-link active" href="javascript:;" onclick="showOp(this)">待办理办件</a>
        </li>
        <li class="nav-item">
      ...
      <div id="tabContent1" class="bg-white p-3">
        ...
        <table class="table">
          <asp:PlaceHolder id="PhRemarks" Visible="false" runat="server">
            <tr>
              <th width="80" class="text-center">意见：</th>
              <td>
                <table class="table">
                  <tr>
                    <td>类型</td>
          ...
          <asp:PlaceHolder id="PhReply" Visible="false" runat="server">
            <tr>
              <th width="80" class="text-center">办理回复：</th>
              <td>
                <table class="table">
                  <tr>
                    <td class="attribute">办理人员</td>
                    <td>
                      <asp:Literal ID="LtlDepartmentAndUserName" runat="server"></asp:Literal>
                    </td>
                  </tr>
                  <tr>
                    <td align="right" class="attribute">办理日期</td>
                    <td>
                      <asp:Literal ID="LtlReplyAddDate" runat="server"></asp:Literal>
                    </td>
                  </tr>
                  <tr>
                    <td align="right" class="attribute">回复内容</td>
                    <td>
                      <asp:Literal ID="LtlReply" runat="server"></asp:Literal>
                    </td>
                  </tr>
                  <tr>
                    <td align="right" class="attribute">附件</td>
                    <td>
